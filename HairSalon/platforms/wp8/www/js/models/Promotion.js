var promotion = {
    ...
    init: function () {
        ...
        this.item[1].content = '<img src="' + this.url + '"/><div>Nội dung đơn hàng</div><textarea id="order_promotion_input"></textarea><div class="btn" onclick="store.user.orderTung()">Đặt mua</div>';
